...
class Actor extends EventDispatcher {
    ...
    spawnActor(actor) {
        this.dispathEvent('spawnactor', new GameEvent(actor));
    }
...
class SpriteActor extends Actor {
    ...
    isOutOfBounds(boundRect) {
        ...
        const actorTop = this.y + this.height;
...
class Scene extends EventDispatcher {
    ...
    add(actor){
        ...
        actor.addEventListener('apawnactor', (e) => this.add(e.target));
